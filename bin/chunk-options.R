# These settings control the default behavior of all chunks in a particular page.
# For example, to generate the a page with all the output hidden, simply change
...
## We use the rmd- prefix for the figures generated by looseleaf so
